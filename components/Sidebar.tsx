...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, toggle }) => {
  ...
  const menuItems = [
    { path: '/', label: 'DASHBOARD', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="3" y="3" width="7" height="7" /><rect x="14" y="3" width="7" height="7" /><rect x="14" y="14" width="7" height="7" /><rect x="3" y="14" width="7" height="7" /></svg> },
    { path: '/planner', label: 'CRONOGRAMA', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /><polyline points="9 22 9 12 15 12 15 22" /></svg> },
    { path: '/evidence', label: 'EVIDENCIAS CHÓFERES', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><rect x="5" y="2" width="14" height="20" rx="2" ry="2" /><line x1="12" y1="18" x2="12.01" y2="18" /></svg> },
    { path: '/chat', label: 'CONSULTA LO QUE NECESITES', icon: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><path d="M12 8V4H8" /><rect x="8" y="8" width="8" height="12" rx="2" /><path d="M2 14h6" /><path d="M16 14h6" /><path d="M12 20v4" /></svg> },
  ];
